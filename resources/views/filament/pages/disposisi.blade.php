...
<x-filament-panels::page>
    ...
    <div style="margin-top:-4px;">
        ...
        <div style="display:flex;flex-wrap:wrap;align-items:flex-end;justify-content:space-between;gap:16px;margin-bottom:24px;">
            <div>
                <h1 class="dp-hero-title">Disposisi Surat</h1>
                <p class="dp-hero-sub">Teruskan dan kelola disposisi surat masuk SMAN 4 Surabaya.</p>
            </div>
        </div>
        ...
        @php
            ...
            if (\App\Support\RoleAccess::isTeacher()) {
                $disposisiQuery->whereIn('diteruskan_ke', \App\Support\RoleAccess::teacherDisposisiRecipients());
            }
        ...
        <div class="dp-stat-grid" style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;margin-bottom:24px;">
            ...
            <div class="dp-stat-card">
                ...
                <p class="dp-stat-lbl">Surat Belum Disposisi</p>
                <p class="dp-stat-val" style="color:#dc2626;">{{ $belumDisposisi }}</p>
                    ...
                    <table class="dp-table" id="dpTable">
                        ...
                        <tbody id="dpTableBody">
                            ...
                            <tr data-status="{{ $d->status }}" data-sifat="{{ $d->sifat }}"
                                ...
                                <td style="white-space:nowrap;color:#424754;font-size:13px;">{{ $d->created_at->format('d M Y') }}</td>
                                ...
                                <td class="right" style="padding-right:16px;" onclick="event.stopPropagation()">
                                    <div style="display:inline-flex;gap:4px;">
                                        ...
                                        <button class="dp-act-btn danger" title="Hapus" wire:click="hapusDisposisi({{ $d->id }})" onclick="return confirm('Hapus disposisi ini?')">
